...
namespace Variables
{
    public class Globals : IGlobals
    {
        ...
        public string CLIENT_ALLOWED_CORS_ORIGIN { get; set; } = "http://localhost:4200";
        ...
        public string SMS_EMAIL_SENDER_NAME { get; set; } = "admin@pixelhorrorstudios.com";

        // These are Default Claims for the Admin User
        public string ADMIN_USER_NAME { get; set; } = "Rob Engel";
